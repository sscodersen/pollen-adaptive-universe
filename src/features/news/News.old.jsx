      ...
      <VStack align="start" spacing={5}>
        ...
        >
          ...
          <VStack align="start" spacing={2} position="relative">
            <HStack>
              ...
              <Heading size="lg">Unbiased Updates</Heading>
            </HStack>
        ...
        <VStack w="100%" spacing={4}>
          ...
          <Button
            ...
            bgGradient="linear(to-r, pink.500, red.600)"
            _hover={{ bgGradient: 'linear(to-r, pink.600, red.700)' }}
          >
            Get News
          </Button>
        </VStack>
        ...
        {data && (
          ...
          >
            <HStack mb={3} spacing={2}>
              <Sparkles size={18} color="var(--chakra-colors-pink-400)" />
              <Text fontSize="sm" fontWeight="semibold" color="pink.300">
                News Summary
              </Text>
            </HStack>
